...
---------------------------------*/
// 量産化用CSV
define('MASTER_CSV_URL',$_SERVER['DOCUMENT_ROOT'].'/attending/senmon_kaigai/setting/master_senmon_kaigai_2017.csv');
// ガイド用CSV
define('MASTER_GUIDE_CSV_URL',$_SERVER['DOCUMENT_ROOT'].'/attending/senmon_kaigai/setting/master_senmon_kaigai_guide_2017.csv');
...
define('KEY_MASTER_CSV_SEARCH_COUNTRY','search_mokuteki_country');  // 検索時の国の指定。シチリア島の都市も含まれる
define('KEY_MASTER_CSV_BEST_SEVEN_DISPLAY','best7_display_flag');   // 基本情報のベスト7の表示フラグ
define('KEY_MASTER_CSV_BLOG_DISPLAY','genchi_blog_display_flag');   // 現地情報ブログの表示フラグ
define('KEY_MASTER_CSV_COUNTRY_COMMON_INFO_DISPLAY','country_common_info_display_flag');    // 基本情報の表示フラグ
define('KEY_MASTER_CSV_SIGHTSEEING_INFO_DISPLAY','sightseeing_info_display_flag');          // 観光情報の表示フラグ
define('KEY_MASTER_CSV_GUIDE_MORE_URL_DISPLAY','guide_more_url');   // ガイド都市ページリンクの表示フラグ
define('KEY_MASTER_CSV_FIRST_LEVEL','first_level');                 // ディレクトリ名2（国、都道府県）
define('KEY_MASTER_CSV_GUIDE_PATH','guide_path');                   // ガイド枠のパス
define('KEY_MASTER_CSV_SEARCH_COUNTRY_UNLIMITED_FLAG','search_mokuteki_country_unlimited_flag');    // スマホ検索枠の目的地-国　の選択制限なしフラグ
define('KEY_MASTER_CSV_SEARCH_COUNTRY_INIT','search_mokuteki_country_initial_selection');           // 初期選択させる国名（複数,カンマ区切り）
...
define('TOURIST_INFOMATION_SP','観光情報SP');
...
// 拠点自由CSV
//define('KYOTEN_FREE_FLAG','');               // 特集フラグ 項目名ないので添字を使用
//define('KYOTEN_FREE_TITLE','');              // 特集枠（見出し）項目名ないので添字を使用
// 拠点特集CSV
//define('KYOTEN_TOKUSYU_FLAG','');           // 特集フラグ 項目名ないので添字を使用
//define('KYOTEN_TOKUSYU_TITLE','');           // 特集枠（見出し）項目名ないので添字を使用
