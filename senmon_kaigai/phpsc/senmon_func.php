<?php
include_once($_SERVER['DOCUMENT_ROOT'] . '/attending/senmon_kaigai/phpsc/common_readCsv.php');

if (!defined( 'MASTER_SESNMON_2017_CSV_URL' )) {
    define('MASTER_SESNMON_2017_CSV_URL',$_SERVER['DOCUMENT_ROOT'] . '/attending/senmon_kaigai/setting/master_senmon_kaigai_2017.csv');
}
