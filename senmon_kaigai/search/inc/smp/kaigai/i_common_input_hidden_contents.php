...
<input type="hidden" id="p_naigai" name="p_naigai" value="W">
<?php // フリープランかどうかのフラグ?>
<?php if($FREE_FLAG):?>
...
<input type="hidden" id="search_country" name="search_country" value="<?php e(json_encode($masterCsv[KEY_MASTER_CSV_SEARCH_COUNTRY])); ?>">
...
<input type="hidden" id="p_mokuteki_kind" name="p_mokuteki_kind" value="<?php e(isset($_POST['p_mokuteki_kind']) ? $_POST['p_mokuteki_kind'] : ''); ?>">
...
<input type="hidden" id="p_timezone" name="p_timezone" value="<?php     e(isset($_POST['p_timezone']) ? $_POST['p_timezone'] : ''); ?>">
<input type="hidden" id="p_seatclass" name="p_seatclass" value="<?php   e(isset($_POST['p_seatclass']) ? $_POST['p_seatclass'] : ''); ?>">
...
<input type="hidden" id="p_discount" name="p_discount" value="<?php     e(isset($_POST['p_discount']) ? $_POST['p_discount'] : ''); ?>">
<input type="hidden" id="p_total_amount_divide" name="p_total_amount_divide" value="<?php e(isset($_POST['p_total_amount_divide']) ? $_POST['p_total_amount_divide'] : ''); ?>">
...
<input type="hidden" id="p_hotel_rank_code" name="p_hotel_rank_code" value="<?php e(isset($_POST['p_hotel_rank_code']) ? $_POST['p_hotel_rank_code'] : ''); ?>">
