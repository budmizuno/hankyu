<?php
$temp_ebook = '/attending/kaigai/inc/temp_ebook_'.$kyotenId.'.php';
if ($kyotenId == 'toy') {
    $temp_ebook = '/attending/kaigai/inc/temp_ebook_hkr.php';
}
?>
<?php if ($kyotenId != 'kmi' && $kyotenId != 'koj' && file_exists($_SERVER['DOCUMENT_ROOT'] . $temp_ebook)) :?>
    <div class="list-inline journey mb20 journey-taipei bdColor">
        ...
        <span class="mid font-14">海外旅行の情報誌をウェブ上でご覧いただけます</span>
    </div>
