<div class="clear">
    <div class="right">
        <?php include_once($PathSenmonCommon . 'sharing/inc/senmonSearchI360.php');//検索	?>
    ...
    <div class="tab-content-slider left">
        <div class="frame mb10 slider-sly" id="sly1">
            ...
            <?php if(isset($osusumeCsv[OSUSUME_CATEGORY_NUM][TOUR_ICHIOSHI_TOUR]) && 0 < $osusumeCsv[OSUSUME_CATEGORY_NUM][TOUR_ICHIOSHI_TOUR]): ?>
                <?php $num=0;?>
            ...
            <?php else: // イチオシツアーがCSVにない場合最安値ツアー表示 ?>
                ...
                <?php else: // 最安値ツアーもないとき?>
                    <script type="text/javascript">
                        // 左枠の高さを変更
                        $("#tab_ct_tour #sly1").css('height','450px');
                    </script>
                    <?php
    ...
    <script type="text/javascript">
        ...
        if(typeof $('#other_facet').val() !== 'undefined' && 0 < $('#other_facet').val().length){
            ...
            $("#otherFacetEtc").html(other_facet_modal);
        }
    </script>
