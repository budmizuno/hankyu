                    ...
                    <?php if($value[KEY_Q_GROUP] == TOUR_URESUZI_RANKING):?>
                        ...
                        <li class="pos-rel">
                            ...
                            <a href="<?=$value[KEY_TOUR_URL];?>">
                                ...
                                <?php endif; ?>
                                <i class="<?=$iconClass;?>"></i>
                                <p class="sly3-ct"><?php if($kyotenId == 'index') echo '<span>'.$value['p_hatsu_name'].'</span>'; ?><?=$value[KEY_Q_COURSE_NAME];?></p>
...
<?php elseif((!isset($osusumeCsv[OSUSUME_CATEGORY_NUM][TOUR_URESUZI_RANKING]) || 0 == $osusumeData[OSUSUME_CATEGORY_NUM][TOUR_URESUZI_RANKING]) && !in_array($kyotenId, $uresuzi_ac_off_kyoten) ): ?>
...
<!-- レコメンド表示場所 -->
<div id="ppz_recommend_pckaigaisenmon03" class="mb20"></div>
<!-- レコメンド表示場所ここまで -->
...
<script type="text/javascript">
    ...
    var ppz_pckaigaisenmon03 = new _PPZ();
    ppz_pckaigaisenmon03.cid = 21017;
    ppz_pckaigaisenmon03.rid = 27;
    ppz_pckaigaisenmon03.customer_id = '<?php e($customerId); ?>'; //顧客IDを代入

    ppz_pckaigaisenmon03.v02 = '1';//内外区分：海外
    ppz_pckaigaisenmon03.v04 = '<?php e($masterCsv[KEY_MASTER_CSV_DEST]); ?>';//目的地フラグを確認
    ppz_pckaigaisenmon03.v08 = "<?php e($p_hatsu);?>"; // ↑↑myHatsuに記載している出発地フラグをカンマ区切りにて記載して下さい。
    ppz_pckaigaisenmon03.v11 = '<?php e($masterCsv[KEY_MASTER_CSV_COUNTRY_LARGE]); ?>';//国コードを記載

    ppz_pckaigaisenmon03.rows = 10;                               //表示したいMAX件数を設定(最大20件)
    ppz_pckaigaisenmon03.cb = 'ppz_pckaigaisenmon03_ranking';               //ここの関数でレコメンド表示を作成してください。(ppz_draw.js)
    ppz_pckaigaisenmon03.div_id = 'ppz_recommend_pckaigaisenmon03';      //レコメンド表示を行うタグのIDを指定(divのIDと一致させます)
    ppz_pckaigaisenmon03.alt_html = null;
    ppz_pckaigaisenmon03.request();
</script>
<?php endif; ?>
