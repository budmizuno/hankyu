...
<?php
	...
	else
	{
		...
		$disp_blog_num_max;
		// 国ページなら
		if($categoryType == CATEGORY_TYPE_COUNTRY){
			// ベスト7があれば
...
<?php if(!empty($blog->Blog)):?>
	...
	<?php if($categoryType == CATEGORY_TYPE_DEST):?>
		<p class="font-18 txt-bold list-inline mb10"><i class="icon icon-home-link mid mr10"></i><span class="font-18 mid">現地情報ブログ</span></p>
