...
function ppz_pckaigaisenmon01_remind(info) {
    //対象レコメンドがあるかないかの判定
    var chekFlg
    ...
    var myHatsuSub = (ppz_recommend_myHatsuSub != "") ? ppz_recommend_myHatsuSub : false;
     ...
     for (var i = 0; i < info.item_list.length; i++) {
        ...
        item_div += '<li>';
        item_div += '<a href="javascript:void(0)" onClick="ppz_pckaigaisenmon01._click(\''+ _corse_url + '\',\'' + _p_course_no +  '\')">';
        item_div += '<dl>';
...
function ppz_pckaigaisenmon03_ranking(info) {
    ...
    var myHatsuSub = (ppz_recommend_myHatsuSub != "") ? ppz_recommend_myHatsuSub : false;
     ...
     for (var i = 0; i < info.item_list.length; i++) {
        ...
        item_div += '<a href="javascript:void(0)" onClick="ppz_pckaigaisenmon03._click(\''+ _corse_url + '\',\'' + _p_course_no +  '\')">';
...
function ppz_pckaigaisenmon02_recommend(info) {
     //対象レコメンドがあるかないかの判定
     var chekFlg
     var target = document.getElementById(info.div_id);
     var _ppz_nodata = "";
    ...
    var myHatsuSub = (ppz_recommend_myHatsuSub != "") ? ppz_recommend_myHatsuSub : false;
     ...
     for (var i = 0; i < info.item_list.length; i++) {
        ...
        item_div += '<li>';
        item_div += '<a href="javascript:void(0)" onClick="ppz_pckaigaisenmon02._click(\''+ _corse_url + '\',\'' + _p_course_no +  '\')">';
        item_div += '<dl>';
        item_div += '<dd class="pht"><img src="//x.hankyu-travel.com/cms_photo_image/image_search_kikan2.php?p_photo_mno='+_p_image_url+'" alt="'+_p_corse_name+'"></dd>';
        item_div += '<dt>'+_p_corse_name+'</dt>';
        item_div += '<dd class="fee">'+ppzYoriMade(_sprice,_eprice)+'</dd>';
    ...
    // フリーツアーの情報があったらHTML表示
    /*if (num > 0) {
        target.innerHTML = '<div class="idx_box01 recently bdr_rgt01 mb30 OnFL js-carousel-box">';
        target.innerHTML += '<h2 class="idx_icn01">最近見たツアー</h2>';
        target.innerHTML += '<button class="sld_prev js-slide-controller"><img src="/sharing/common16/images/sld_prev.png"></button>';
        target.innerHTML += '<button class="sld_next js-slide-controller"><img src="/sharing/common16/images/sld_next.png"></button>';
        target.innerHTML += '<div class="js-carousel-container">';
        target.innerHTML += '<div id="recentTour" class="js-carousel">';
        target.innerHTML += '<ul>'+item_div+'</ul>';
        target.innerHTML += '</div>';
        target.innerHTML += '<div class="scrollbar"><div class="handle"><div class="mousearea"></div></div></div>';
        target.innerHTML += '</div>';
        target.innerHTML += '</div>';
    }*/
