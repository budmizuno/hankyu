...
function ppz_spkokunaisenmon01_remind(info) {
     //対象レコメンドがあるかないかの判定
     var chekFlg
     ...
     for (var i = 0; i < info.item_list.length; i++) {
		...
		item_div += '<a href="javascript:void(0)" onClick="ppz_spkokunaisenmon01._click(\''+ _corse_url + '\',\'' + _p_course_no +  '\')">';
...
function ppz_spkokunaisenmon02_recommend(info) {
	 //対象レコメンドがあるかないかの判定
	 var chekFlg
	 var target = document.getElementById(info.div_id);
	 var _ppz_nodata = "";
	...
	var myHatsuSub = (ppz_recommend_myHatsuSub != "") ? ppz_recommend_myHatsuSub : false;
	 ...
	 for (var i = 0; i < info.item_list.length; i++) {
		...
		item_div += '<li class="tour swiper-slide">';
		item_div += '<a href="javascript:void(0)" onClick="ppz_spkokunaisenmon02._click(\''+ _corse_url + '\',\'' + _p_course_no +  '\')">';
		item_div += '<p><img src="//x.hankyu-travel.com/cms_photo_image/image_search_kikan3.php?p_photo_mno='+_p_image_url+'" alt="'+_p_corse_name+'"></p>';
		item_div += '<dl>';
		item_div += '<dt>'+_p_corse_name+'</dt>';
		item_div += '<dd>'+ppzYoriMade(_sprice,_eprice)+'</dd>';
...
function ppz_spkokunaisenmon03_ranking(info) {
	 //対象レコメンドがあるかないかの判定
	 var chekFlg
	 var target = document.getElementById(info.div_id);
	 var _ppz_nodata = "";
	...
	var myHatsuSub = (ppz_recommend_myHatsuSub != "") ? ppz_recommend_myHatsuSub : false;
	 ...
	 for (var i = 0; i < info.item_list.length; i++) {
        ...
        item_div += '<a href="javascript:void(0)" onClick="ppz_spkokunaisenmon03._click(\''+ _corse_url + '\',\'' + _p_course_no +  '\')">';
