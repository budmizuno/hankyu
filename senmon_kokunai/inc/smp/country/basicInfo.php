<?php if ( (isset($masterCsv[KEY_MASTER_CSV_TAG_INFO]) && !empty($masterCsv[KEY_MASTER_CSV_TAG_INFO])) 
        || ($touristInfomationCsv != null && count($touristInfomationCsv) > 0) ) :?>
<h2 class="list-inline main-title mb20 mainBgClr">
    <?php if ($categoryType == CATEGORY_TYPE_DEST || $categoryType == CATEGORY_TYPE_COUNTRY) :?>
...
<?php // 国の基本情報リンク ※下記データはcsv /var/www/html/hankyu-travel.com/attending/senmon_kokunai/setting/master_senmon_kaigai_2017.csv の tag_country_common_info にある ?>
<?php if (isset($masterCsv[KEY_MASTER_CSV_TAG_INFO])) echo $masterCsv[KEY_MASTER_CSV_TAG_INFO]; ?>
