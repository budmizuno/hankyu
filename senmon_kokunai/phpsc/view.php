...
echo "</pre>";
	*/
	...
	if(!empty($landSharePath)){
		...
		$incPath = $PathSenmonCommon. 'inc/genchiHacchaku/'.$tmp_name;
	}
...
EOD;
		...
		if(isset($GlobalTourData['price_min_max']) && (strpos($GlobalTourData['price_min_max'],'受付終了') !== false || $GlobalTourData['price_min_max'] == 0 || $GlobalTourData['price_min_max'] == '')){
			//URLがDSかどうか判定
